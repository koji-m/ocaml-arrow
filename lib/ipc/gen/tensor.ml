(** Automatically generated by the FlatBuffers compiler
    ...
    root type: org.apache.arrow.flatbuf.Tensor (//Tensor.fbs)
...
module Union_ = struct
  let read_table_type___1 ?none ?null ?int ?floating_point ?binary ?utf8 ?bool ?decimal ?date ?time ?timestamp ?interval ?list ?struct_ ?union ?fixed_size_binary ?fixed_size_list ?map ?duration ?large_binary ?large_utf8 ?large_list ?run_end_encoded ?binary_view ?utf8_view ?list_view ?large_list_view ~default b i t o =
    ...
    module Arrow = struct
      module Flatbuf = struct
        ...
        module Tensor = struct
          ...
          let[@inline] type_ ?none ?null ?int ?floating_point ?binary ?utf8 ?bool ?decimal ?date ?time ?timestamp ?interval ?list ?struct_ ?union ?fixed_size_binary ?fixed_size_list ?map ?duration ?large_binary ?large_utf8 ?large_list ?run_end_encoded ?binary_view ?utf8_view ?list_view ?large_list_view ~default b o = Union_.read_table_type___1 b 6 (type_type b o) ?none ?null ?int ?floating_point ?binary ?utf8 ?bool ?decimal ?date ?time ?timestamp ?interval ?list ?struct_ ?union ?fixed_size_binary ?fixed_size_list ?map ?duration ?large_binary ?large_utf8 ?large_list ?run_end_encoded ?binary_view ?utf8_view ?list_view ?large_list_view ~default o
        ...
        module Field = struct
          ...
          let[@inline] type_ ?none ?null ?int ?floating_point ?binary ?utf8 ?bool ?decimal ?date ?time ?timestamp ?interval ?list ?struct_ ?union ?fixed_size_binary ?fixed_size_list ?map ?duration ?large_binary ?large_utf8 ?large_list ?run_end_encoded ?binary_view ?utf8_view ?list_view ?large_list_view ~default b o = Union_.read_table_type___1 b 10 (type_type b o) ?none ?null ?int ?floating_point ?binary ?utf8 ?bool ?decimal ?date ?time ?timestamp ?interval ?list ?struct_ ?union ?fixed_size_binary ?fixed_size_list ?map ?duration ?large_binary ?large_utf8 ?large_list ?run_end_encoded ?binary_view ?utf8_view ?list_view ?large_list_view ~default o
