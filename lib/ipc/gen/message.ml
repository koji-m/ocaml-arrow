...
module Union_ = struct
  let read_table_message_header__2 ?none ?schema ?dictionary_batch ?record_batch
      ?tensor ?sparse_tensor ~default b i t o =
    match Rt.UType.to_default t with
    | 0L when Option.is_some none -> Option.get none
    | 1L when Option.is_some schema ->
        Option.get schema (Rt.Ref.read_table b o i)
    | 2L when Option.is_some dictionary_batch ->
        Option.get dictionary_batch (Rt.Ref.read_table b o i)
    | 3L when Option.is_some record_batch ->
        Option.get record_batch (Rt.Ref.read_table b o i)
    | 4L when Option.is_some tensor ->
        Option.get tensor (Rt.Ref.read_table b o i)
    | 5L when Option.is_some sparse_tensor ->
        Option.get sparse_tensor (Rt.Ref.read_table b o i)
    | _ -> default t

  let read_table_sparse_tensor_index__3 ?none ?sparse_tensor_index_coo
      ?sparse_matrix_index_csx ?sparse_tensor_index_csf ~default b i t o =
    match Rt.UType.to_default t with
    | 0L when Option.is_some none -> Option.get none
    | 1L when Option.is_some sparse_tensor_index_coo ->
        Option.get sparse_tensor_index_coo (Rt.Ref.read_table b o i)
    | 2L when Option.is_some sparse_matrix_index_csx ->
        Option.get sparse_matrix_index_csx (Rt.Ref.read_table b o i)
    | 3L when Option.is_some sparse_tensor_index_csf ->
        Option.get sparse_tensor_index_csf (Rt.Ref.read_table b o i)
    | _ -> default t

  let read_table_type___4 ?none ?null ?int ?floating_point ?binary ?utf8 ?bool
      ...
      module Flatbuf = struct
        ...
        module SparseTensorIndex = struct
          ...
          let to_string e =
            ...
            | x ->
                "<org.apache.arrow.flatbuf.SparseTensorIndex: "
                ^ Int64.to_string x ^ ">"
        end
        ...
        module MessageHeader = struct
          ...
          let to_string e =
            ...
            | 5L -> "sparse_tensor"
            | x ->
                "<org.apache.arrow.flatbuf.MessageHeader: " ^ Int64.to_string x
                ^ ">"
        end
        ...
        module Tensor = struct
          ...
          let[@inline] type_ ?none ?null ?int ?floating_point ?binary ?utf8
            ...
            Union_.read_table_type___4 b 6 (type_type b o) ?none ?null ?int
        ...
        module SparseTensorIndexCoo = struct
          ...
          let[@inline] is_canonical b o =
            Rt.Bool.(read_table_default b o 10 ~default:(of_default false))
          ...
          module Builder = struct
            ...
            let add_indices_buffer =
              Rt.Struct.push_slot Struct.set_buffer__0 16 8 2

            let add_is_canonical =
              Rt.Bool.(push_slot_default 3 ~default:(of_default false))
          end
        end
        ...
        module SparseTensor = struct
          ...
          let[@inline] non_zero_length b o =
            Rt.Long.(read_table_default b o 10 ~default:(of_default 0L))

          let[@inline] sparse_index_type b o =
            Rt.UType.(read_table_default b o 12 ~default:(of_default 0L))

          let[@inline] sparse_index ?none ?sparse_tensor_index_coo
              ?sparse_matrix_index_csx ?sparse_tensor_index_csf ~default b o =
            Union_.read_table_sparse_tensor_index__3 b 14
              (sparse_index_type b o) ?none ?sparse_tensor_index_coo
              ?sparse_matrix_index_csx ?sparse_tensor_index_csf ~default o
          ...
          module Builder = struct
            ...
            let add_non_zero_length =
              Rt.Long.(push_slot_default 3 ~default:(of_default 0L))

            let add_sparse_index_sparse_tensor_index_coo =
              Rt.Ref.push_union 4 5 SparseTensorIndex.sparse_tensor_index_coo

            let add_sparse_index_sparse_matrix_index_csx =
              Rt.Ref.push_union 4 5 SparseTensorIndex.sparse_matrix_index_csx

            let add_sparse_index_sparse_tensor_index_csf =
              Rt.Ref.push_union 4 5 SparseTensorIndex.sparse_tensor_index_csf
        ...
        module SparseMatrixIndexCsx = struct
          ...
          let[@inline] compressed_axis b o =
            Rt.Short.(read_table_default b o 4 ~default:(of_default 0L))
          ...
          module Builder = struct
            ...
            let add_compressed_axis =
              Rt.Short.(push_slot_default 0 ~default:(of_default 0L))

            let add_indptr_type = Rt.Ref.push_slot 1

            let add_indptr_buffer =
              Rt.Struct.push_slot Struct.set_buffer__0 16 8 2

            let add_indices_type = Rt.Ref.push_slot 3

            let add_indices_buffer =
              Rt.Struct.push_slot Struct.set_buffer__0 16 8 4
          end
        end
        ...
        module Message = struct
          ...
          let[@inline] header_type b o =
            Rt.UType.(read_table_default b o 6 ~default:(of_default 0L))

          let[@inline] header ?none ?schema ?dictionary_batch ?record_batch
              ?tensor ?sparse_tensor ~default b o =
            Union_.read_table_message_header__2 b 8 (header_type b o) ?none
              ?schema ?dictionary_batch ?record_batch ?tensor ?sparse_tensor
              ~default o

          let[@inline] body_length b o =
            Rt.Long.(read_table_default b o 10 ~default:(of_default 0L))
          ...
          module Builder = struct
            ...
            let add_header_dictionary_batch =
              Rt.Ref.push_union 1 2 MessageHeader.dictionary_batch

            let add_header_record_batch =
              Rt.Ref.push_union 1 2 MessageHeader.record_batch

            let add_header_tensor = Rt.Ref.push_union 1 2 MessageHeader.tensor

            let add_header_sparse_tensor =
              Rt.Ref.push_union 1 2 MessageHeader.sparse_tensor
        ...
        module FieldNode = struct
          ...
          module Vector = Rt.Struct.Vector (struct
            ...
            let size = 16
            let set = Struct.set_field_node__1
          end)
        ...
        module Field = struct
          ...
          let[@inline] type_ ?none ?null ?int ?floating_point ?binary ?utf8
              ...
              ?large_binary ?large_utf8 ?large_list ?run_end_encoded
              ?binary_view ?utf8_view ?list_view ?large_list_view ~default b o =
            Union_.read_table_type___4 b 10 (type_type b o) ?none ?null ?int
              ?floating_point ?binary ?utf8 ?bool ?decimal ?date ?time
              ?timestamp ?interval ?list ?struct_ ?union ?fixed_size_binary
              ?fixed_size_list ?map ?duration ?large_binary ?large_utf8
              ?large_list ?run_end_encoded ?binary_view ?utf8_view ?list_view
        ...
        module BodyCompression = struct
          ...
          let[@inline] codec b o =
            Rt.Byte.(read_table_default b o 4 ~default:(of_default 0L))

          let[@inline] method_ b o =
            Rt.Byte.(read_table_default b o 6 ~default:(of_default 0L))
          ...
          module Builder = struct
            ...
            let add_codec =
              Rt.Byte.(push_slot_default 0 ~default:(of_default 0L))

            let add_method_ =
              Rt.Byte.(push_slot_default 1 ~default:(of_default 0L))
          end
        end
