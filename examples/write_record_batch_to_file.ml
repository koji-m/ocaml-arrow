...
let f64_array = Arrow_array.Primitive_array.Float64_array.of_array [|Some 3.14; Some 2.718; None; Some 1.618 |] in
...
|] in
let struct_fields = [|
    Arrow_schema.Schema.Field.({type_ = Arrow_schema.Datatype.Int32; name = "struct_num1"});
...
let boolean_array = Arrow_array.Boolean_array.of_boolean_array [| Some true; Some false; None; Some true|] in
let batch = Arrow_array.Record_batch.({schema = {
    fields = [|
        ...
        {type_ = Arrow_schema.Datatype.List Arrow_schema.Field.({type_ = Arrow_schema.Datatype.Int32; name = "inner"}); name = "i32_list"};
        {type_ = Arrow_schema.Datatype.Struct struct_fields; name = "struct1"};
    ...
    columns = [|
        ...
        Arrow_array.Array_intf.Array((module Arrow_array.Primitive_array.Float64_array), f64_array);
        ...
        Arrow_array.Array_intf.Array((module Arrow_array.Boolean_array), boolean_array);
    |]}) in
